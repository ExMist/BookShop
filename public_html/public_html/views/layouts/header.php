...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" href="/template/ico.ico" type="image/x-icon">
                        ...
                        <div class="col-sm-6">
                            <div class="contactinfo">
                                <ul class="nav nav-pills">
                                    ...
                                    <li><a href="#"><i class="fa fa-envelope"></i> polimax@gmail.com</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-6">
                                ...
                                <ul class="nav navbar-nav collapse navbar-collapse">
                                    ...
                                    <li class="dropdown"><a href="/">Магазин<i class="fa fa-angle-down"></i></a>
                                        <ul role="menu" class="sub-menu">
                                            <li><a href="/catalog/">Наш ассортимент</a></li>
                                            <li><a href="/cart/">Корзина</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="/about/">История магазина</a></li>
