        ...
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        <div class ="slsl" style="background-image: url(<?php echo Product::getImage($product['id']); ?>)" > </div>
                ...
                <div class="recommended_items"><!--recommended_items-->
                    <h2 class="title text-center">Выбор редакции</h2>
                         ...
                         >                        
                            ...
                            <div class="item">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <div class ="recomm" style="background-image: url(<?php echo Product::getImage($sliderItem['id']); ?>)" > </div>
